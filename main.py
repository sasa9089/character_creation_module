...
"""Вызываем функцию random и возвращаем случайное число."""
...
def attack(char_name: str, char_class: str) -> str:
    """Эта функция отвечает за атаку персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Эта функция отвечает за хп персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Эта функция отвечает за специальные навыки."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция выбора имени и типа персонажа."""
